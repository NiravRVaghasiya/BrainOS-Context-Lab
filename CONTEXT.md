...
# base install (extras hidden): 1132 passed, 104 skipped, 0 failed
...
Phase 19 is complete and validated (1331 tests with every extra installed,
94.14% coverage against a 90% floor, `ruff check .` clean, 101 shipped files
